...
<div class="container" style="font-size: 20px; width: auto;">	
	...
	<div class="panel-heading" style="font-size: 20px;">
		<div class="row">
			...
			<div class="col-md-2" align="right" style="font-size: 20px;">
				<button type="button" name="add" id="addUser" class="btn btn-success btn-xs" style="font-size: 20px;">Add New</button>
			</div>
		</div>
	</div>
			
	<table id="listUser" class="table table-bordered table-striped" style="font-size: 20px; color: white;">
		<thead>
	...
	<div id="userModal" class="modal fade" style="font-size: 20px;">
